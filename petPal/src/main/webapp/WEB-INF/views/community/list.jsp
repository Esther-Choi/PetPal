			...
			<div id="wrapper">	
				<div id="bar" style="background-color: white;">
					<div style="display: flex; align-items: center; position: relative; z-index: 4;">
						<a href="javascript:void(0);" style="margin-right: 5px;" onclick="show()"><span>용현5동</span></a>
				...
				<a href="/com/form.do" id="write">
					<i class="fas fa-pencil-alt"></i>
				</a>
				<!-- Nav -->
				<nav id="nav">
					<a href="/walk/list.do" class="icon solid"><i class="fas fa-paw"></i><p>홈</p></a>
					<a href="javascript:void(0)" onclick="goTop()" class="icon solid" style="opacity: 1 !important;"><i class="fas fa-bullhorn"></i><p>커뮤니티</p></a>
								...
								$(data).each(
										function(){
											str += "<li id='list-content' class='scrolling' num='"+this.num+"'>"
												+	"<a href='/com/view.do?num="+this.num+"'>"
												+	"<div id='content'>"
												+	"<span id = 'com-type'>"+this.type+"</span>"
												+	"<p id='title'>"+this.title+"</p>"
												+	"<ul>"
												+	"<li><span id='writer'>"+this.user_id+"</span></li>"
												+	"<li><span>&#183;</span></li>"
												+	"<li><span id='date'>"+this.date+"</span></li>"
												+	"</ul>"
												+	"</div></a>"
												+	"<div id='sub'>"
												+	"<a href='javascript:void(0)' class='like'><i class='far fa-heart like'></i><span id='like-text'>좋아요</span></a>"
