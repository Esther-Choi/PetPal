			...
			<form name="frm" action="/user/join.do" method="post"
				...
				<div id="file-div">
					<div class="file-upload">
						<label for="upload" class="file-upload__label"><i
							...
							class="file-upload__input" type="file" name="file">
					</div>
					<div id="file-img">
						<img src="" width="48em" height="48em" alt=""
							style="display: none;">
				...
				<div id="address">
					...
					<div>
						...
						<input type="hidden" name="si"> <input type="hidden"
							name="gungu"> <input type="hidden" name="dong">
					</div>
				</div>
				<div id="time-box" class="surgery-box">
					...
					<div class="surgery">
						<button type="button" id="ma" onclick="$.fnSurgery(this)"
							value="YES">YES</button>
						<button type="button" onclick="$.fnSurgery(this)" value="NO">NO</button>
						<input type="hidden" name="surgery">
					</div>
					<span id="birth-span" style="width: 45px;">몸무게</span> <input
						name="pet_weight" type="number" id="weight"> <span
						style="font-size: 0.8em; margin-left: 5px;">kg</span>
				</div>
				<div id="style-box">
					<span>좋아하는거</span> <input name="likes" type="text" placeholder="">
				</div>
				<div id="style-box">
				...
				<div id="style-box">
					...
					<div>
						<button type="button" class="character" onclick="$.fnDays(this)"
							value="순함">순함</button>
						<button type="button" onclick="$.fnDays(this)" value="예민">예민</button>
						<button type="button" onclick="$.fnDays(this)" value="활발">활발</button>
						<button type="button" onclick="$.fnDays(this)" value="소심">소심</button>
						<button type="button" onclick="$.fnDays(this)" value="인싸">인싸</button>
						<button type="button" onclick="$.fnDays(this)" value="아싸">아싸</button>
						<button type="button" onclick="$.fnDays(this)" value="난폭">난폭</button>
				...
				<div id="submit-btn">
					<a href="javascript:void(0)" onclick="$.fnSubmitForm()"><span>완료</span></a>
				</div>
			</form>
		</div>
