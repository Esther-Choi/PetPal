...
SELECT * FROM TBL_WALK_LIKE twl;
SELECT * FROM TBL_WALK W JOIN TBL_WALK_LIKE L ON W.NUM = L.BOARD_NUM WHERE L.USER_ID = 'test2' AND L.LIKECHECK = 1;
...
SELECT
		...
		ON W.NUM = L.BOARD_NUM WHERE ROWNUM BETWEEN 1 AND 20 AND L.USER_ID = 'test2' AND L.LIKECHECK = 1;
...
CREATE SEQUENCE SEQ_PET_FOLLOW;

CREATE TABLE TBL_PET_FOLLOW(
	NUM NUMBER(10) NOT NULL,
	USER_ID VARCHAR(20) NOT NULL,
	FOLLOW_ID VARCHAR(20) NOT NULL,
	CONSTRAINTS PET_FOLLOW_PK PRIMARY KEY(NUM),
	CONSTRAINTS PET_FOLLOW_FK FOREIGN KEY(USER_ID) REFERENCES TBL_USER(USER_ID)
);
